...
const documentModel        = require('./data/models/document');
const documentChunksModel  = require('./data/models/document_chunks');
const financialRecordsModel = require('./data/models/financial_records');
...
async function start() {
  try {
    ...
    await documentRepository.ensureIndexes();
    console.log('[app] documents, document_chunks, financial_records, and risk_alerts collections ready');
