...
} = require('./prompts/riskExplanationPrompt');
const fallback = require('./prompts/riskExplanationFallback');

const ZAI_ENDPOINT =
  process.env.ZAI_API_ENDPOINT || 'https://api.z.ai/v1/chat/completions';
