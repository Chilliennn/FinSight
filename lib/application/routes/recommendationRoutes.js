 ...
 *
 * Routes:
 *   GET    /recommendations/item/:id     fetch single rec by _id
 *   GET    /recommendations/:businessId  fetch all active recs + summary
 *   POST   /recommendations/generate     generate via Z.AI from transactions
 *   PATCH  /recommendations/:id/action   mark as actioned
 *   PATCH  /recommendations/:id          partial update (e.g. dismiss)
 *   DELETE /recommendations/:id          hard delete
 *
 * ── POST /generate body ───────────────────────────────────────────────────────
 *
