...
Total: Generate ALL applicable recommendations from the data — one per overdue invoice (days_overdue > 14), one per upcoming expense (amount > RM 3,000), one per cost area (monthly spend > RM 500), plus exactly one Financing item last. Do NOT cap the total count.
