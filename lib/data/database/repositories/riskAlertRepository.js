 ...
 * Logic and aiEngine layers call these functions instead of touching the driver.
 */
 ...
 * affected_amount desc — matches the UI rendering order.
 */
...
async function clearActiveByBusiness(businessId) {
  const db = await getDb();
  return db
    .collection(COLLECTION)
    .updateMany(
